...
if errorlevel 1 exit /b 1
rem No console window: the helper is started from a shortcut and lives as long as the launcher.
cl /nologo /std:c++17 /EHsc /W4 /utf-8 /MT /DUNICODE /D_UNICODE attach.cpp /Fo%out%\attach.obj /Fe%out%\launcher-attach.exe /link user32.lib /SUBSYSTEM:WINDOWS /ENTRY:wmainCRTStartup
exit /b %errorlevel%
