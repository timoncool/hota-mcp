...
internal static class GameCommands
{
    ...
    public static GameCommand ForAction(AvailableAction action, Observation before) => action.Key switch
    {
        ...
        "garrison:close" => new("adventure", Deliveries.Control(30722, "iOK6432.def")),
        ...
        "exchange:pack:left:forward" => new("exchange", Deliveries.Control(101, "hsbtns5.def")),
        "exchange:pack:right:back" => new("exchange", Deliveries.Control(100, "hsbtns3.def")),
        "exchange:pack:right:forward" => new("exchange", Deliveries.Control(102, "hsbtns5.def")),
