...
internal sealed class GameReader(WindowsGame game,int player)
{
    ...
    private Observation ReadOnce()
    {
        ...
        for(int controlIndex=0;controlIndex<controls.Count;controlIndex++)
        {
            ...
            bool bareControlMatters=screen is "town_hall" or "town_fort" or "adventure" or "hero_screen" or "building_confirmation" or "popup_choice" or "tavern" or "battle_result" or "marketplace"||(screen is "message" or "exchange" or "level_up")&&(state&2)!=0;
